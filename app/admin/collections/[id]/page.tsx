                        ...
                        <div className="space-y-3">
                            ...
                            <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100">
                                {imageInputMode === 'UPLOAD' ? (
                                    <div className="space-y-3">
                                        <FileUpload
                                            label="Change Collection Image (Upload)"
                                        ...
                                        {formData.image && (
                                            <div className="text-sm text-slate-600 bg-white px-3 py-2 rounded-lg border border-slate-100 flex items-center space-x-2">
                                                ...
                                                <a href={formData.image} target="_blank" rel="noreferrer" className="text-indigo-600 hover:text-indigo-800 text-xs font-medium">View</a>
                                            </div>
                                        )}
                                    </div>
                                ) : (
